        ...
        *,
        ...
        diagnostics = {
            ...
            "current_form": {
                ...
                # ------------------------------------------------
                # V3.1 DIAGNOSTIC ADDITION
                # ------------------------------------------------
                #
                # match_gap уже вычисляется и используется в
                # GoalModel, но раньше не выводился в diagnostics.
                # Добавляем его для полного и согласованного
                # отображения в UI.
                # ------------------------------------------------
