...
class PassportManager:
    ...
    #
    # новое значение =
    # старое значение + DELTA * LEARNING_RATE
    #
    LEARNING_RATE = 0.10
    ...
    def create_passport(
        ...
        try:
            ...
            # ----------------------------------------------------
            # Сохраняем служебные данные ДО CLAMP
            # ----------------------------------------------------
    ...
    def update_passport(
        ...
        if absolute_form is not None:
            ...
            try:
                ...
                new_data["form"] = self._clamp(
                    float(absolute_form),
                    "form"
                )

                logger.debug(
                    "Absolute form updated | "
                    "team=%s | form=%.2f",
        ...
        new_data["faj_rating"] = (
            self.calculate_rating(
                ...
                results_strength=(
                    results_strength
                    if results_strength is not None
                    else None
                ),
    ...
    def _apply_weighted_changes(
        ...
        Обычные математические DELTA:
            получают opponent_factor.
    ...
    def _calculate_match_changes(
        ...
        # key_player_loss
        #
        # не обучаются от результата матча.
        # --------------------------------------------------------
