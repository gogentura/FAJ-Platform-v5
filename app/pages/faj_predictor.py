...
# ============================================================
# COLLECTION (UPDATED: без сортировки, доверяем порядку URL)
# ============================================================
...
def collect_team_history(
    ...
    Логика:
        Soccer365 URLs (порядок: свежие → старые)
              ↓
        parse_soccer365()
              ↓
        validate
    ...
    ВАЖНО:
        ...
        - forecast_date используется только для фильтрации будущих матчей
    ...
    #
    # НЕ сортируем здесь по match_date.
    # --------------------------------------------------------
