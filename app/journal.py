...
class Journal:
    ...
    def save(
        ...
        try:
            ...
            league = prediction.get("league", "RPL")
            ...
            cur.execute(
                ...
                (
                    ...
                    prediction.get("risk", "Средний"),

                    prediction.get("grade", "C"),
                    prediction.get("grade_name", "Высокий риск")
                )
            )
    ...
    def get_last_predictions(self, limit=10):
